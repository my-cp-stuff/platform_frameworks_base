...
public class NavigationModeController implements Dumpable {
    ...
    private final class DERPSettingsObserver extends ContentObserver {
        public DERPSettingsObserver(Handler handler) {
            super(handler);
        }
    ...
    private DERPSettingsObserver mSettingsObserver;
    ...
    public NavigationModeController(Context context,
        ...
        mSettingsObserver = new DERPSettingsObserver(new Handler());
