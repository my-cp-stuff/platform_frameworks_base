...
//      animateShow(mClockController.getClockLayout(), animate);
    ...
    private void updateStatusBarLogo(boolean animate) {
        ...
        switch(mLogoStyle) {
            ...
            case 1:
                logo = getContext().getResources().getDrawable(R.drawable.status_bar_derp);
                break;
                // Owl
            case 2:
                ...
                // Owl 2
            case 3:
                logo = getContext().getResources().getDrawable(R.drawable.status_bar_owl2);
                break;
                // OnePlus
            case 4:
                logo = getContext().getResources().getDrawable(R.drawable.status_bar_oneplus);
                break;
                // Death Star
            case 5:
                logo = getContext().getResources().getDrawable(R.drawable.status_bar_deathstar);
                break;
                // Default DerpFest HOME logo, once again
            default:
                logo = getContext().getResources().getDrawable(R.drawable.ic_status_bar_derp_logo);
                break;
        }
        ...
        if (mDerpLogo != null) {
            if (logo == null) {
                ...
                mDerpLogo.setImageDrawable(logo);
                mShowLogo = false;
                return;
            }
        ...
        if (mNotificationIconAreaInner != null) {
            if (mShowLogo) {
                ...
                animateHiddenState(mDerpLogo, View.GONE, animate);
            }
        }
    }
}
