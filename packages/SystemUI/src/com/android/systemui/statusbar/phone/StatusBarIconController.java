...
public interface StatusBarIconController {
    ...
    public static class DarkIconManager extends IconManager {
        ...
        protected void destroy() {
            ...
            Dependency.get(DerpSettingsService.class).removeObserver(this);
        }
     ...
     */
    public static class IconManager implements DemoMode, DerpSettingsService.DerpSettingsObserver {
        ...
        protected StatusBarMobileView addMobileIcon(int index, String slot, MobileIconState state) {
            ...
            mGroup.addView(view, index, onCreateLayoutParams());
            Dependency.get(DerpSettingsService.class).addIntObserver(this, Settings.System.USE_OLD_MOBILETYPE);
